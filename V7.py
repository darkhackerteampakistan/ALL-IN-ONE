...
# =========================
# SAFE JOIN SYSTEM (IMPORTANT FIX)
# =========================

async def ensure_join(client, chat):
    try:
...
async def comment_post():
    ...
    entity = await ensure_join(c, chat)

    if not entity:
        print("Cannot access chat")
        return

    try:
        await c.send_message(entity, comment, reply_to=msg_id)
        print("Comment sent")
